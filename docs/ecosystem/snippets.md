...
- **Rounded Corners**: Adds rounded corners to all elements across Schoolbox.
- **Hide PFP**: Hide your profile picture across Schoolbox.
- **Hide PWA Prompt**: Hides the prompt in the notifications menu to install Schoolbox as a PWA and enable notifications.
